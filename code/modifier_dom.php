...
$id_domaine = intval($_GET['id_du_domaine']);

$Requete_SQL_preparation = "SELECT * FROM domaine WHERE id_domaine = :id_domaine";
...
$domaine = $Requete_preparer->fetch(PDO::FETCH_ASSOC);
...
if (!empty($_POST)){
    ...
    if (!empty($_POST['saisie_domaine'])){
        ...
        $formulaireValide = false;
            ...
            if ($formulaireValide == true){
                    ...
                    $Requete_SQL_Preparation = "UPDATE domaine SET nom_domaine = :nom_domaine WHERE id_domaine = :id_domaine";
    ...
    $valeur_du_domaine = htmlspecialchars($domaine['nom_domaine']);
    ...
    <div class="flex justify-center font-PE_libre_baskerville m-2 md:m-8">
        ...
        <div class="informations  bg-orange-200border flex flex-col justify-center align-middle border border-black  w-3/4">
            <div class="flex flex-col md:flex-row mb-5 md:mb-0">
                <div class="md:w-1/4 w-full  bg-orange-200 h-full flex  border-b font-PE_libre_baskerville_italique border-black p-4 font-bold items-center justify-between"><p>Gérer ce domaine </p><i class="fa-solid fa-gear"></i></i></div>
                ...
                <form action="index.php" method="GET">
                    ...
                    <form action="suprimer_dom.php" method="GET">
                        <button type="submit" name="id_du_domaine" class="m-2 p-2 rounded bg-blue-950" value="<?php echo $domaine['id_domaine'] ?>">
            ...
            <div class="flex flex-col md:flex-row mb-5 md:mb-0">
            <div class="md:w-1/4 w-full h-max bg-orange-200  border-b font-PE_libre_baskerville_italique border-black p-4 font-bold flex justify-between items-center"><p >ID du domaine <span class="text-red-600">*</span></p> <i class="flex justify-center items-center text-red-600  fa-solid fa-lock"></i> </div>
                <p class=" w-full pl-5 border-b bg-orange-100 border-black flex justify-start items-center"><?php echo $domaine['id_domaine'] ?></p>
            ...
            <div class="flex flex-col md:flex-row mb-5 md:mb-0">
                ...
                <div class="flex flex-col w-full ">
                    <input onkeyup="ChangerCouleurIcone_edit('saisie_libelle_dom')" type="text" id="saisie_libelle_dom" name="saisie_domaine" onkeyup="changercouleur_categorie_edit()" class=" w-full pl-5 border-b h-full bg-orange-100  flex  items-center" placeholder="Entrer un nom de libelle" value="<?php echo $valeur_du_domaine ?>"></input>
            ...
            <div class="flex flex-col md:flex-row md:mb-0 ">
                <p class="md:w-1/4 w-full hidden md:flex bg-orange-200    border-b font-PE_libre_baskerville_italique p-4 font-bold items-center justify-center">Validation </p>
                <div class="flex justify-center item-center w-full bg-orange-100">
                    <button type="submit"  class="bg-blue-950 items-center text-orange-600 mt-2 p-6 font-PE_nunito rounded flex justify-around mr-5 mb-5" >
                        <i class="mr-4 text-orange-600 fa-solid fa-pen-clip"></i>Editer le domaine
                    </button> 
                </div>
            </div>
