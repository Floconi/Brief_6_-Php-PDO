...
?>
    ...
    <div class="flex justify-center font-PE_libre_baskerville m-2 md:m-8">
        ...
        <div class="informations  bg-orange-200border flex flex-col justify-center align-middle border border-black  w-3/4">
            <div class="flex flex-col md:flex-row mb-5 md:mb-0">
                ...
                <form action="index.php" method="GET">
                    ...
                    <form action="supprimer.php" method="GET">
                        <button type="submit" name="id_du_favori" class="m-2 p-2 rounded bg-blue-950" value="<?php echo $domaine['id_domaine'] ?>">
            ...
            <div class="flex flex-col md:flex-row mb-5 md:mb-0">
                <div class="md:w-1/4 w-full bg-orange-200 h-max flex border-b font-PE_libre_baskerville_italique  p-4 font-bold items-center justify-between"><p>Libelle du domaine <span class="text-red-600">*</span></p><i id="saisie_libelle_icone" class="fa-solid fa-pencil"></i></div>
                <div class="flex flex-col w-full ">
                    <input onkeyup="ChangerCouleurIcone_edit('saisie_libelle')" type="text" id="saisie_libelle" name="saisie_domaine" onkeyup="changercouleur_categorie_edit()" class=" w-full pl-5 border-b h-full bg-orange-100  flex  items-center" placeholder="Entrer un nom de libelle" value="<?php echo $valeur_du_domaine ?>"></input>
